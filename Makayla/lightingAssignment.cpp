//g++ -w -o Jennifer.exe gl_utils.cpp maths_funcs.cpp lightingAssignment.cpp libglfw3dll.a libglew32.dll.a -I include -lglew32 -lglfw3 -lgdi32 -lopengl32

//g++ -w -o Jennifer.exe gl_utils.cpp maths_funcs.cpp lightingAssignment.cpp libglfw3dll.a libglew32.dll.a -I include -lglfw3 -lgdi32 -lopengl32

//g++ -w -o Makayla.exe gl_utils.cpp maths_funcs.cpp lightingAssignment.cpp libglfw3dll.a libglew32.dll.a -I include -lglfw3 -lgdi32 -lopengl32

//g++ -w -o Makayla.exe gl_utils.cpp maths_funcs.cpp lightingAssignment.cpp libglfw3dll.a libglew32.dll.a -I include -lglew32 -lglfw3 -lgdi32 -lopengl32
...
//read in vertices
void loadFacesNew(string modelName, GLint faces[]){    
    ...
    //for (int z0 = 0; z0 < 100; z0++){
        ...
        if (strcmp(buf,label) == 0){
        //cout << "vertex" << endl;
        fscanf(objFile, "%f/%f/%f %f/%f/%f %f/%f/%f %f/%f/%f\n", &a, &b, &c, &a1, &b1, &c1, &a1, &b1, &c1, &a1, &b1, &c1);
        //cout << "a,b,c: " << a << ", " << b << ", " << c << endl;
...
//figure out how to calculate all the normals
...
int main () {
	...
	string modelName = "TropicalFish01.obj";
	...
	/*GLuint shader_programme = create_programme_from_files (
		"test_vs.glsl", "test_fs_spotlight.glsl");*/
